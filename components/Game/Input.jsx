...
const TypingInput = forwardRef(({ text, time }, ref) => {
    ...
    return (
      <Flex position='relative' maxW='950px' width='100%' flexDirection='column'>
        <Text pos='absolute' left='0' top='-10' zIndex='40' fontSize='2xl' fontWeight='600' color='green.300'>
          {timeLeft}
        </Text>
        ...
        >
          ...
          <Flex pos='absolute' right='0' top='-40' zIndex='40' fontSize='2xl' fontWeight='600' color='green.300' background='gray.700' rounded='2xl' padding='1rem'>
